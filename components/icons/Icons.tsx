...
// Credit Card Icon
export const CardIcon = ({ className = '', size = 24 }: IconProps) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
...
// Transactions/Chart Icon
export const TransactionIcon = ({ className = '', size = 24 }: IconProps) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
...
// Crypto/Bitcoin Icon
export const CryptoIcon = ({ className = '', size = 24 }: IconProps) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
  ...
  >
    ...
    <path d="M9.5 9a2.5 2.5 0 0 1 5 0v2a2.5 2.5 0 0 1-5 0" />
    <path d="M9.5 11a2.5 2.5 0 0 0 5 0v2a2.5 2.5 0 0 1-5 0" />
...
// Top Up/Plus Icon
export const TopUpIcon = ({ className = '', size = 24 }: IconProps) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
...
// Support/Help Icon
export const SupportIcon = ({ className = '', size = 24 }: IconProps) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
...
// Exchange/Swap Icon
export const ExchangeIcon = ({ className = '', size = 24 }: IconProps) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
...
export const NFCIcon = ({ className = '', size = 24 }: IconProps) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
...
// IBAN Icon
export const IBANIcon = ({ className = '', size = 24 }: IconProps) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
...
// Loan Icon
export const LoanIcon = ({ className = '', size = 24 }: IconProps) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
...
// Investment Icon
export const InvestmentIcon = ({ className = '', size = 24 }: IconProps) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
...
// Mortgage Icon
export const MortgageIcon = ({ className = '', size = 24 }: IconProps) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
...
// Budget Icon
export const BudgetIcon = ({ className = '', size = 24 }: IconProps) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
...
export const RecurringIcon = ({ className = '', size = 24 }: IconProps) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
...
// ATM Icon
export const ATMIcon = ({ className = '', size = 24 }: IconProps) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
...
// Bonds Icon
export const BondsIcon = ({ className = '', size = 24 }: IconProps) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
...
// Credit Score Icon
export const CreditScoreIcon = ({ className = '', size = 24 }: IconProps) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
...
export const SettingsIcon = ({ className = '', size = 24 }: IconProps) => (
  ...
  >
    ...
    <path d="M12 1v6m0 6v6m0-6h6m-6 0H6m13.66-3.66l-4.24 4.24m0 0l-4.24 4.24m4.24-4.24l4.24-4.24m-4.24 4.24L6.34 17.66" />
  </svg>
);

// Statement Icon
export const StatementIcon = ({ className = '', size = 24 }: IconProps) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
